...
class ReconocedorFrente implements Runnable {
    ...
    ReconocedorFrente(Billete needle, List<Billete> haystack, AtomicBoolean billeteEncontrado, AtomicReference<String> resultado) {
        this.needle = needle;
